...
import static cn.element.web.servlet.View.DEFAULT_CONTENT_TYPE;
...
public class DispatcherServlet extends HttpServlet {
    ...
    public void init(ServletConfig config) {
        // 相当于把IoC容器初始化了
        ApplicationContext context = new ClassPathXmlApplicationContext(config.getInitParameter(LOCATION));
    ...
    private void doDispatch(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (handler == null) {
            ResponseEntity<Void> result = ResponseEntity.notFound();
            processDispatchResult(request, response, new ModelAndView("404", null, result));
            return;
        }
...
//        }
    ...
    private void processDispatchResult(HttpServletRequest request, HttpServletResponse response, ModelAndView mv) throws Exception {
        ...
        String json = mapper.writeValueAsString(mv.getResponseEntity());

package cn.element.ioc.test.chap18;
...
import cn.element.ioc.test.chap18.bean.Husband;
import cn.element.ioc.test.chap18.converter.StringToIntegerConverter;
...
public class ApiTest {
    ...
    public void testConvert() {
        ApplicationContext applicationContext = new ClassPathXmlApplicationContext("classpath:application18.xml");

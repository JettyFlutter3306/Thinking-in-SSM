package cn.element.ioc.test.stage11;
...
import cn.element.ioc.test.stage11.bean.IUserService;
...
public class ApiTest {
    ...
    public void testAop() throws NoSuchMethodException {
        AspectJExpressionPointcut pointcut = new AspectJExpressionPointcut("execution(* cn.element.ioc.test.stage11.bean.UserService.*(..))");
    ...
    public void testDynamic() {
        ...
        advisedSupport.setMatcher(new AspectJExpressionPointcut("execution(* cn.element.ioc.test.stage11.bean.IUserService.*(..))"));
    ...
    public void testProxyMethod() {
        ...
        IUserService proxy = (IUserService) Proxy.newProxyInstance(
            ...
            new InvocationHandler() {
                // 方法匹配器
                MethodMatcher methodMatcher = new AspectJExpressionPointcut("execution(* cn.element.ioc.test.stage11.bean.IUserService.*(..))");

package cn.element.orm.datasource.pooled;
...
/**
 * 通过 PooledConnection 实现 InvocationHandler invoke 方法，包装代理链接，
 * 这样就可以对具体的调用方法进行控制了。
 * 在 invoke 方法中处理对 CLOSE 方法控制以外，
 * 排除 toString 等Object 的方法后，则是其他真正需要被 DB 链接处理的方法了。
 * 那么这里有一个对于 CLOSE 方法的数据源回收操作 dataSource.pushConnection(this); 
